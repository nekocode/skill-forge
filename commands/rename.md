...
4. **Abort if active draft references old name.** Check `.claude/skill_draft.md` — if it exists and references `old-name`, warn user and abort (finish the improve/create session first).
